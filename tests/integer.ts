...
var expectValue = (testOpts: TestOptions<number>) => expectValueExecutor((): any => Settings.integer(VARNAME, testOpts.defaultValue, testOpts.opts), testOpts);
var expectError = (testOpts: TestOptions<number>) => expectErrorExecutor((): any => Settings.integer(VARNAME, testOpts.defaultValue, testOpts.opts), testOpts);
